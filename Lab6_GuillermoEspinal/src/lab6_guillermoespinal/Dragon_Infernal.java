...
public class Dragon_Infernal extends Cartas {
    ...
    public Dragon_Infernal(/*String nombre,*/ int dano, int puntosvida/*, String objetivo, String velocidad, String tipo*/) {
         super.nombre="Dragon Infernal";
        super.dano=dano;
        ...
        super.costo=4;
        //asi?
        super.carta=new Dragon_Infernal();
        //super(nombre, dano, puntosvida, objetivo, velocidad, tipo);
    }
    //Dragon Infernal(Legendaria):Velocidad Media y Objetivos Aereos y Terrestres.Cuesta 4 de Elixir.
